...
if (ready) {
    ...
    if (global.option[p2]=-1) draw_sprite(spr_rostercard,7,x,y)
        ...
        if showsprays {
            draw_sprite_part(global.chariconsp[global.option[p2],global.playerskin[p2]+(global.playerskin[p2]!=0)],0,8+(8*global.pal_1[p2]),8,8,8,x-23,y-23)
            draw_sprite_part(global.chariconsp[global.option[p2],global.playerskin[p2]+(global.playerskin[p2]!=0)],0,8+(8*global.pal_2[p2]),16,8,8,x-23+8,y-23)
            draw_sprite_part(global.chariconsp[global.option[p2],global.playerskin[p2]+(global.playerskin[p2]!=0)],0,8+(8*global.pal_3[p2]),24,8,8,x-23+16,y-23)
            draw_sprite_part(global.chariconsp[global.option[p2],global.playerskin[p2]+(global.playerskin[p2]!=0)],0,8+(8*global.pal_4[p2]),32,8,8,x-23+24,y-23)
        }
